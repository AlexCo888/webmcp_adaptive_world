...
a predefined personalized-routine template. The entitlement does not unlock
additional medical fields, clinician access, or hidden catalog facts.

A person without an agent can still buy Routine Pro on the Gym site. That path
lets them choose a published, versioned staff walkthrough, which Gym grounds in
the same approved projection and verified inventory and saves to Passport. It
is always labeled as a staff walkthrough chosen on the Gym site, never as
agent-generated or AI-personalized. One entitlement covers both paths.
...
| Public staff walkthroughs                                                          | Fixed, versioned, staff-authored demo content; purchasable on the site, never presented as agent work |
