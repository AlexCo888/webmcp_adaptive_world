...
| 1:00–1:25 | Enter Prompt 1. Pause on requested goal, movement considerations, stop signals, expiry, and excluded data; approve. Remove the face-camera bubble.                             | “The demo records are synthetic, but the authorization flow is real. My Passport prepares the exact twenty-minute, one-use projection. Before anything leaves, I can review the goal, movement context, and everything excluded: my name, diagnoses, medications, labs, and documents. I approve.”                                                                                                                                                                                                                                                                                                                                                                                                                                       |
